    ...
    methods
        ...
        function [tableModel,groupTableModel] = buildTableModelsForClassDefn(this)
            ...
            for i = 1:numel(klass.PropertyList)
                ...
                c{iRow,4} = mprojectnavigator.internal.Utils.propertyAccessLabel(...
            ...
            for i = 1:numel(klass.MethodList)
                ...
                c{iRow,4} = mprojectnavigator.internal.Utils.methodAccessLabel(...
                    meth.Access);
            ...
            for i = 1:numel(klass.EventList)
                ...
                c{iRow,3} = '';
                c{iRow,4} = mprojectnavigator.internal.Utils.eventAccessLabel(...
