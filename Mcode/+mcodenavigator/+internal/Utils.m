classdef Utils
    methods (Static)
        ...
        function guiRevealFileInDesktopFileBrowser(file)
            ...
            browserName = mcodenavigator.internal.Utils.osFileBrowserName;
            if ismac
        ...
        function out = methodAccessLabel(access)
            out = mcodenavigator.internal.Utils.memberAccessLabel(access);
        ...
        function out = propertyAccessLabel(getAccess, setAccess)
            ...
            getAccessLabel = mcodenavigator.internal.Utils.memberAccessLabel(getAccess);
            setAccessLabel = mcodenavigator.internal.Utils.memberAccessLabel(setAccess);
        ...
        function out = eventAccessLabel(notifyAccess, listenAccess)
            ...
            notifyAccessLabel = mcodenavigator.internal.Utils.memberAccessLabel(notifyAccess);
            listenAccessLabel = mcodenavigator.internal.Utils.memberAccessLabel(listenAccess);
