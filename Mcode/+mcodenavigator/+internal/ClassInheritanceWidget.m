classdef ClassInheritanceWidget < mcodenavigator.internal.TreeWidget
    ...
    methods
        function this = ClassInheritanceWidget(classDefn)
            this = this@mcodenavigator.internal.TreeWidget();
            if nargin == 0
                return;
            end
        ...
        function out = buildClassNode(this, classDefn)
            nodeData = mcodenavigator.internal.ClassInheritanceNodeData;
            nodeData.type = 'class';
