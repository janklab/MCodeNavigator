classdef Log4jConfigurator
    ...
    %     'root'    'INFO'
    %     'net.apjanke.mcodenavigator.swing'  'DEBUG'
    %     });
    %
    % mcodenavigator.internal.Log4jConfigurator.prettyPrintLogConfiguration
    %
    % % Display fully-qualified class/category names in the log output:
    % mcodenavigator.internal.Log4jConfigurator.setRootAppenderPattern(...
    ...
    methods (Static)
        ...
        function setLevels(levels)
            ...
            for i = 1:size(levels, 1)
                ...
                level = mcodenavigator.internal.Log4jConfigurator.getLog4jLevel(levelName);
