classdef FileWidgetBase < mcodenavigator.internal.TreeWidget
    ...
    methods
        ...
        function out = setupTreeContextMenu(this, node, nodeData)
            ...
            hasUsableTerminal = mcodenavigator.internal.Utils.isSupportedTerminalInstalled;
            ...
            if isTargetFileOrDir
                ...
                if mcodenavigator.internal.Utils.isPowerShellInstalled
...
mcodenavigator.internal.Utils.openTerminalSessionAtDir(dir);
end

function ctxPowerShellHereCallback(src, evd, this, nodeData) %#ok<INUSL>
dir = ifthen(nodeData.isDir, nodeData.path, fileparts(nodeData.path));
mcodenavigator.internal.Utils.openPowerShellAtDir(dir);
end
